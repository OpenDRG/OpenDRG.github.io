...
**在线使用时，为了医院数据安全，分组规则要下载到本地，计算过程中不发送任何网络数据；网站带宽有限，页面加载时间可能较长，请耐心等待**
**下载后使用的话，不需要访问网络，无任何延迟**

## 联系开发团队
请发邮件至OpenDRG@hotmail.com，或加微信13801750519

## 在大家的大力支持下，OpenDRG除了DRG/DIP分组器外，已成功开发多套专业软件，包括医保DRG/DIP管理系统、医保智能审核系统、运营数据分析系统、医院绩效分配系统，欢迎洽谈商业合作
